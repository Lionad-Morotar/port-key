...
- Bash — `scripts/bump-version.sh`、`scripts/translate-readme.sh`(README 自动翻译)
...
- 推荐使用 `fabric` CLI(`scripts/translate-readme.sh` 通过 `fabric -p translate` 翻译 README,`sponge` 写回)
